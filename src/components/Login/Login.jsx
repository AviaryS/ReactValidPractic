    ...
    return (
        <div className="login">
            <form action="" className="login__form" onSubmit={onSubmit}>
                <p>
                    Работает только с admin admin,
                    т.к. я думаю нет особого смысла мне мучаться,
                    когда итоговая аунтефикация будет по токену
                </p>
                <input
                    type="text"
                    placeholder="Name"
                ...
                {userError && (
                    <p style={{ color: "red" }}>Имя или пароль введены не верно</p>
                )}
